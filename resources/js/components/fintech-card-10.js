            ...
            // Line
            {
              ...
              backgroundColor: function(context) {
                ...
                return chartAreaGradient(ctx, chartArea, [
                  { stop: 0, color: adjustColorOpacity(getCssVariable('--color-rose-500'), 0) },
                  { stop: 1, color: adjustColorOpacity(getCssVariable('--color-rose-500'), 0.2) }
                ]);
              }, 
              ...
              pointRadius: 0,
              pointHoverRadius: 3,
              pointBackgroundColor: getCssVariable('--color-rose-500'),
              pointHoverBackgroundColor: getCssVariable('--color-rose-500'),
              pointBorderWidth: 0,
