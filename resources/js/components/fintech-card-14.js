...
// Import utilities
import { formatValue, getCssVariable } from '../utils';
          ...
          data: {
            ...
            datasets: [
              // Line
              {
                ...
                borderColor: miniChart.growth ? getCssVariable('--color-green-500') : getCssVariable('--color-rose-500'),
                borderWidth: 2,
                pointRadius: 0,
                pointHoverRadius: 3,
                // eslint-disable-next-line max-len
                pointBackgroundColor: miniChart.growth ? getCssVariable('--color-green-500') : getCssVariable('--color-rose-500'),
                pointHoverBackgroundColor: miniChart.growth ? getCssVariable('--color-green-500') : getCssVariable('--color-rose-500'),
                pointBorderWidth: 0,
