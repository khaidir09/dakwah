<div>
    ...
    <div class="sm:flex sm:justify-between sm:items-center mb-8">
        ...
        <div class="grid grid-flow-col sm:auto-cols-max justify-start sm:justify-end gap-2">
            ...
            <!-- Search form -->
            <x-search-form placeholder="Masukkan judul tulisan" />

            <a href="{{ route('posts.create') }}" class="btn bg-gray-900 text-gray-100 hover:bg-gray-800 dark:bg-gray-100 dark:text-gray-800 dark:hover:bg-white">
                <svg class="fill-current shrink-0 xs:hidden" width="16" height="16" viewBox="0 0 16 16">
                    <path d="M15 7H9V1c0-.6-.4-1-1-1S7 .4 7 1v6H1c-.6 0-1 .4-1 1s.4 1 1 1h6v6c0 .6.4 1 1 1s1-.4 1-1V9h6c.6 0 1-.4 1-1s-.4-1-1-1z" />
                </svg>
                <span class="max-xs:sr-only">Tambah Tulisan</span>
            </a>
        </div>
    </div>
    ...
    <div class="bg-white dark:bg-gray-800 shadow-xs rounded-xl">
        <header class="px-5 py-4">
            <h2 class="font-semibold text-gray-800 dark:text-gray-100">Semua Tulisan</h2>
        </header>
                        ...
                        <tr>
                            ...
                            <td class="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap w-px">
                                <div class="space-x-1 flex">
                                    <a href="{{ route('posts.edit', $post->id) }}" class="text-gray-400 hover:text-gray-500 dark:text-gray-500 dark:hover:text-gray-400 rounded-full">
                                ...
                                <div class="p-5 flex space-x-4">
                                    ...
                                    <div>
                                        ...
                                        <div class="flex flex-wrap justify-end space-x-2">
                                            ...
                                            >
                                                <span wire:loading.remove wire:target="deletePost">Ya, Hapus</span>
                                                <span wire:loading wire:target="deletePost">Menghapus...</span>
                                            </button>
                                        </div>
                                    </div>
                                </div>
