<div class="bg-white dark:bg-gray-800 p-4 rounded-xl shadow-sm" x-data="{ open: false }">
    ...
    <div x-show="open" x-collapse class="mt-4">
        @if($schedule)
            ...
            <div class="mt-4 pt-3 border-t border-gray-100 dark:border-gray-700/60 text-center flex flex-col items-center">
                <span class="text-[10px] text-gray-400 dark:text-gray-500 mb-1">{{ $schedule['tanggal'] }}</span>
