<div>
    ...
    <div class="grid xl:grid-cols-2 gap-6 mb-8">
        ...
        <article class="flex bg-white dark:bg-gray-800 shadow-xs rounded-xl overflow-hidden">
            <!-- Image -->
            <div class="block w-56 xl:sidebar-expanded:w-40 2xl:sidebar-expanded:w-56 shrink-0">
                <img class="object-cover object-center w-full h-full" src="{{ $event->image ? Storage::url($event->image) : asset('images/meetups-thumb-01.jpg') }}" width="220" height="236" alt="{{ $event->name }}" />
            </div>
            <!-- Content -->
