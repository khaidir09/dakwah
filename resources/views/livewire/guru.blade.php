<div>
    ...
    <div class="sm:flex sm:justify-between sm:items-center mb-8">
        ...
        <div class="mb-4 sm:mb-0">
            <h1 class="text-2xl md:text-3xl text-gray-800 dark:text-gray-100 font-bold">Guru</h1>
        </div>
        ...
        <div class="grid grid-flow-col sm:auto-cols-max justify-start sm:justify-end gap-2">
            ...
            <!-- Search form -->
            <x-search-form placeholder="Masukkan nama guru" />

            <!-- Add customer button -->
            <a href="{{ route('guru.create') }}" class="btn bg-gray-900 text-gray-100 hover:bg-gray-800 dark:bg-gray-100 dark:text-gray-800 dark:hover:bg-white">
                <svg class="fill-current shrink-0 xs:hidden" width="16" height="16" viewBox="0 0 16 16">
                    <path d="M15 7H9V1c0-.6-.4-1-1-1S7 .4 7 1v6H1c-.6 0-1 .4-1 1s.4 1 1 1h6v6c0 .6.4 1 1 1s1-.4 1-1V9h6c.6 0 1-.4 1-1s-.4-1-1-1z" />
                </svg>
                <span class="max-xs:sr-only">Tambah Guru</span>
            </a>                      
    ...
    <div class="bg-white dark:bg-gray-800 shadow-xs rounded-xl">
        <header class="px-5 py-4 border-b border-gray-100 dark:border-gray-700/60">
            <div class="flex items-center justify-between">
                <h2 class="font-semibold text-gray-800 dark:text-gray-100">Guru <span class="text-gray-400 dark:text-gray-500 font-medium">{{ $teachers_count }}</span></h2>
                    ...
                    <tr>
                        ...
                        <td class="px-2 first:pl-5 last:pr-5 py-3">
                            <div class="flex items-center gap-2">
                                ...
                                <form action="{{ route('admin.moderasi.guru', $item->id) }}" method="POST" x-data x-on:submit.prevent="
                                ...
                                <a href="{{ route('guru.edit', $item->id) }}" class="btn-xs bg-gray-200 hover:bg-gray-300 text-gray-700">Lihat</a>
                            </div>
                        </td>
                    </tr>
                    @empty
            ...
            <table class="table-auto w-full dark:text-gray-300">
                ...
                <thead class="text-xs font-semibold uppercase text-gray-500 dark:text-gray-400 bg-gray-50 dark:bg-gray-900/20 border-t border-b border-gray-100 dark:border-gray-700/60">
                    <tr>
                        ...
                        <th class="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap">
                            <div class="font-semibold text-left">Tahun Lahir</div>
                        </th>
                        <th class="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap">
                            <div class="font-semibold text-left">Domisili</div>
                        </th>
                        <th class="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap">
                ...
                <tbody class="text-sm divide-y divide-gray-100 dark:divide-gray-700/60">
                    ...
                    @foreach($teachers as $item)
                        <tr>
                            ...
                            <td class="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap">
                                <div class="text-left">{{ $item->village?->name }}</div>
                            </td>
                            <td class="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap">
                                @if ($item->wafat_masehi === null)
                                    <div class="text-sm inline-flex font-medium bg-violet-500/20 text-violet-600 rounded-full text-center px-2.5 py-1">Aktif</div>
                                @else
                                    <div class="text-sm inline-flex font-medium bg-red-500/20 text-red-700 rounded-full text-center px-2.5 py-1">Wafat {{ $item->wafat_masehi }}</div>
                                @endif
                            </td>
                            <td class="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap">
                                <div class="text-left">
                            ...
                            <td class="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap w-px">
                                <div class="space-x-1 flex">
                                    <a href="{{ route('guru.edit', $item->id) }}" class="text-gray-400 hover:text-gray-500 dark:text-gray-500 dark:hover:text-gray-400 rounded-full">
                                ...
                                <div class="p-5 flex space-x-4">
                                    ...
                                    <div>
                                        ...
                                        <div class="flex flex-wrap justify-end space-x-2">
                                            ...
                                            >
                                                <span wire:loading.remove wire:target="deleteTeacher">Ya, Hapus</span>
                                                <span wire:loading wire:target="deleteTeacher">Menghapus...</span>
                                            </button>
                                        </div>
                                    </div>
                                </div>
