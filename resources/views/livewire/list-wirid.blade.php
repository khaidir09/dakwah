                        ...
                        <footer class="flex justify-between items-center space-x-3">
                            ...
                            <div>
                                ...
                                <button
                                    ...
                                    class="flex items-center {{ isset($wirid->is_liked) && $wirid->is_liked ? 'text-red-500 hover:text-red-600' : 'text-gray-400 dark:text-gray-500 hover:text-violet-500 dark:hover:text-violet-500' }}">
