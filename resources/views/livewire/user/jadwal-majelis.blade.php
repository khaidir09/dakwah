<div>
    ...
    <div class="p-6 bg-white dark:bg-gray-800">
        ...
        <div class="sm:flex sm:justify-between sm:items-center mb-8">
            <div class="mb-4 sm:mb-0">
                <h2 class="text-2xl text-gray-800 dark:text-gray-100 font-bold">Jadwal Majelis</h2>
            </div>
            ...
            <div class="grid grid-flow-col sm:auto-cols-max justify-start sm:justify-end gap-2">
                ...
                <!-- Add customer button -->
                <a href="{{ route('kelola-jadwal-majelis.create') }}" class="btn bg-gray-900 text-gray-100 hover:bg-gray-800 dark:bg-gray-100 dark:text-gray-800 dark:hover:bg-white">
    ...
    <div class="bg-emerald-600 shadow-sm rounded-tl-xl rounded-tr-xl">
        <header class="px-5 py-4">
            <h2 class="font-semibold text-white">Semua Jadwal Majelis <span class="text-gray-400 font-medium">{{ $schedules_count }}</span></h2>
        </header>
                        ...
                        <tr>
                            ...
                            <td class="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap w-px">
                                <div class="space-x-1 flex">
                                    <a href="{{ route('kelola-jadwal-majelis.edit', $item->id) }}" class="text-gray-400 hover:text-gray-500 dark:text-gray-500 dark:hover:text-gray-400 rounded-full">
