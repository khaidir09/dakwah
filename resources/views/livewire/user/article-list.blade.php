<div>
    ...
    <div class="p-6 bg-white dark:bg-gray-800">
        ...
        <div class="sm:flex sm:justify-between sm:items-center mb-8">
            <div class="mb-4 sm:mb-0">
                <h2 class="text-2xl text-gray-800 dark:text-gray-100 font-bold">Artikel</h2>
            </div>
            ...
            <div class="grid grid-flow-col sm:auto-cols-max justify-start sm:justify-end gap-2">
                ...
                <a href="{{ route('kelola-artikel.create') }}" class="btn bg-gray-900 text-gray-100 hover:bg-gray-800 dark:bg-gray-100 dark:text-gray-800 dark:hover:bg-white">
                    ...
                    <span class="max-xs:sr-only">Tambah Artikel</span>
                </a>                      
    ...
    <div class="bg-emerald-600 shadow-sm rounded-tl-xl rounded-tr-xl">
        <header class="px-5 py-4">
            <h2 class="font-semibold text-white">Semua Artikel <span class="text-gray-400 font-medium">{{ $articles_count }}</span></h2>
        </header>
            ...
            <table class="table-auto w-full dark:text-gray-300">
                ...
                <thead class="text-xs font-semibold uppercase text-gray-500 dark:text-gray-100 bg-gray-50 dark:bg-gray-900/90 border-t border-b border-gray-100 dark:border-gray-700/90">
                    <tr>
                        ...
                        <th class="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap">
                            <div class="font-semibold text-left">Tanggal Terbit</div>
                        </th>
                        <th class="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap">
                        ...
                        <tr>
                            ...
                            <td class="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap w-px">
                                <div class="space-x-1 flex">
                                    <a href="{{ route('kelola-artikel.edit', $article->id) }}" class="text-gray-400 hover:text-gray-500 dark:text-gray-500 dark:hover:text-gray-400 rounded-full">
                                    ...
                                    <div>
                                        ...
                                        <div class="flex flex-wrap justify-end space-x-2">
                                            ...
                                            <button 
                                                ...
                                                wire:target="deleteArticle"
                                                class="btn-sm bg-red-500 hover:bg-red-600 text-white"
                                            >
                                                <span wire:loading.remove wire:target="deleteArticle">Ya, Hapus</span>
                                                <span wire:loading wire:target="deleteArticle">Menghapus...</span>
                                            </button>
                                        </div>
                                    </div>
                                </div>
