    ...
    <form method="POST" action="{{ route('login') }}">
        ...
        <div class="mt-6">
            ...
            <div class="mt-4 text-center text-xs text-gray-500 dark:text-gray-400">
                <p>Gunakan akun Google untuk masuk dengan cepat dan aman, Login Praktis &amp; Aman. Kami menggunakan Google OAuth untuk keamanan maksimal. Tidak perlu mengingat password!</p>
            </div>
