    ...
    <div class="flex flex-start space-x-4">
        ...
        <div class="grow">
            ...
            <h2 class="font-semibold text-gray-800 dark:text-gray-100 mb-2">
                <a href="{{ route('forum-post') }}">Share Your Startup - December 2024 - Upvote This For Maximum Visibility!</a>
            </h2>
            <!-- Footer -->
...
<article class="bg-white dark:bg-gray-800 shadow-xs rounded-xl p-5">
    <div class="flex flex-start space-x-4">
        <!-- Avatar -->
        <div class="shrink-0 mt-1.5">
        <img class="w-8 h-8 rounded-full" src="{{ asset('images/company-icon-06.svg') }}" width="32" height="32" alt="Crypto" />
        </div>
        <!-- Content -->
        <div class="grow">
            <!-- Title -->
