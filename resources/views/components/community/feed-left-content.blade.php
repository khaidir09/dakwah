                    ...
                    <ul class="flex flex-nowrap md:block mr-3 md:mr-0">
                        ...
                        <li class="mr-0.5 md:mr-0 md:mb-0.5">
                             <a class="flex items-center px-2.5 py-2 rounded-lg whitespace-nowrap @if(request()->routeIs('event*')) bg-white dark:bg-gray-800 @endif" href="{{ route('event-list') }}">
                                <svg class="shrink-0 fill-current @if(request()->routeIs('event*')) text-violet-500 @else text-gray-400 dark:text-gray-500 @endif mr-2" width="16" height="16" viewBox="0 0 16 16">
                                    <path d="M8 3.414V6a1 1 0 1 1-2 0V1a1 1 0 0 1 1-1h5a1 1 0 0 1 0 2H9.414l6.293 6.293a1 1 0 1 1-1.414 1.414L8 3.414Zm0 9.172V10a1 1 0 1 1 2 0v5a1 1 0 0 1-1 1H4a1 1 0 0 1 0-2h2.586L.293 7.707a1 1 0 0 1 1.414-1.414L8 12.586Z" />
                                </svg>
