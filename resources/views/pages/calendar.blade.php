<x-app-layout>
    <div class="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-[96rem] mx-auto" x-data="calendar" x-init="initCalendar">
        ...
        <!-- Calendar table -->
        <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm overflow-hidden" x-cloak>
