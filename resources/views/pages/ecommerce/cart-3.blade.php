                ...
                <div class="py-8 px-4 lg:px-8 2xl:px-12">
                    <div class="max-w-sm mx-auto lg:max-w-none">
                        ...
                        <div class="space-y-6">
                            ...
                            <div class="mt-6">
                                <div class="mb-4">
                                    <a href="{{ route('pay') }}" class="btn w-full bg-gray-900 text-gray-100 hover:bg-gray-800 dark:bg-gray-100 dark:text-gray-800 dark:hover:bg-white">View Your Order</a>
                                </div>
