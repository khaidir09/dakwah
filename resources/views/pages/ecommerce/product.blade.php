    ...
    <div class="px-4 sm:px-6 lg:px-8 py-8 w-full">
        ...
        <div class="max-w-5xl mx-auto flex flex-col lg:flex-row lg:space-x-8 xl:space-x-16">
            ...
            <div>
                ...
                <!-- Image -->
                <figure class="mb-6">
                    <img class="w-full rounded-xs" src="{{ asset('images/product-image.jpg') }}" width="640" height="360" alt="Product" />
                </figure>
                    ...
                    <ul class="space-y-8 sm:space-y-5 my-6">
                        ...
                        <li class="sm:flex items-center">
                            <a class="block mb-4 sm:mb-0 mr-5 md:w-32 xl:w-auto shrink-0" href="#0">
                                <img class="rounded-xs" src="{{ asset('images/related-product-01.jpg') }}" width="200" height="142" alt="Product 01" />
                            </a>
                            <div class="grow">
                                <a href="#0">
                        ...
                        <li class="sm:flex items-center">
                            <a class="block mb-4 sm:mb-0 mr-5 md:w-32 xl:w-auto shrink-0" href="#0">
                                <img class="rounded-xs" src="{{ asset('images/related-product-02.jpg') }}" width="200" height="142" alt="Product 02" />
                            </a>
                            <div class="grow">
                                <a href="#0">
                        ...
                        <li class="sm:flex items-center">
                            <a class="block mb-4 sm:mb-0 mr-5 md:w-32 xl:w-auto shrink-0" href="#0">
                                <img class="rounded-xs" src="{{ asset('images/related-product-03.jpg') }}" width="200" height="142" alt="Product 03" />
                            </a>
                            <div class="grow">
                                <a href="#0">
