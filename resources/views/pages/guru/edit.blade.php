                ...
                <div class="bg-white dark:bg-gray-800 p-6 shadow sm:rounded-tl-md sm:rounded-tr-md">
                    ...
                    <div class="grid grid-cols-1 mt-6">
                        <div>
                            ...
                            <input id="source" class="form-input w-full @error('source') is-invalid @enderror" type="text" name="source" value="{{ old('source', $guru->source ?? '') }}" placeholder="Contoh: Wikipedia, Buku Sejarah Ulama, dll"/>
                            @error('source')
                                <div class="text-xs mt-1 text-red-500">{{ $message }}</div>
                            @enderror
                        </div>
