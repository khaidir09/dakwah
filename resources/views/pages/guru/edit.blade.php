        ...
        <div>
            ...
            <form action="{{ route('guru.update', $guru->id) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="bg-white dark:bg-gray-800 p-6 shadow sm:rounded-tl-md sm:rounded-tr-md">
                    ...
                    <div class="grid grid-cols-1 mt-6" x-data="{ sources: {{ Js::from($guru->source ?? [['name' => '', 'url' => '']]) }} }">
                    ...
                    <div class="grid grid-cols-1 mt-6">
                        <div>
                            <label class="block text-sm font-medium mb-1" for="biografi">Biografi <span class="text-red-500">*</span></label>
                            ...
                            <textarea id="biografi" class="hidden form-textarea w-full" name="biografi" rows="10">{{ old('biografi', $guru->biografi) }}</textarea>
    ...
    <script type="module">
        ...
        window.addEventListener('load', function() {
            ...
            const editor = new Editor({
                ...
                content: document.getElementById('biografi').value,
                editorProps: {
                    attributes: {
                ...
                onUpdate: ({ editor }) => {
                    document.getElementById('biografi').value = editor.getHTML();
                }
            });
