    ...
    <div class="grow">
        <div class="p-6 space-y-6">
            <div class="sm:flex sm:justify-between sm:items-center mb-8">
                <h2 class="text-2xl font-bold text-gray-800 dark:text-gray-100">Tambah Guru (Kontribusi)</h2>
            ...
            @include('pages.kontributor.guru._form', ['action' => route('kontributor.guru.store'), 'method' => 'POST', 'guru' => null])
        </div>
    </div>
</x-dashboard-layout>
