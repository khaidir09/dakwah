    ...
    <div class="grow">
        <div class="p-6 space-y-6">
            <div class="sm:flex sm:justify-between sm:items-center mb-8">
                <h2 class="text-2xl font-bold text-gray-800 dark:text-gray-100">Edit Majelis Kontribusi</h2>
            ...
            @if($majelis->rejection_reason)
                <div class="p-4 bg-red-50 border border-red-200 text-red-800 rounded-lg">
                    <strong>Alasan penolakan:</strong> {{ $majelis->rejection_reason }}
                </div>
            @endif

            @include('pages.kontributor.majelis._form', [
                'action' => route('kontributor.majelis.update', $majelis->id),
                'method' => 'PUT',
                'majelis' => $majelis,
            ])
        </div>
