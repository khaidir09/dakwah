    ...
    <div class="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-[96rem] mx-auto">
        ...
        <div class="sm:flex sm:justify-between sm:items-center mb-8">
            <div class="mb-4 sm:mb-0">
                <h1 class="text-2xl md:text-3xl text-gray-800 dark:text-gray-100 font-bold">Edit Role</h1>
            </div>
                ...
                <div class="bg-white dark:bg-gray-800 p-6 shadow sm:rounded-tl-md sm:rounded-tr-md">
                    <div class="grid grid-cols-1 gap-6">
                        ...
                        <div>
                            ...
                            <input id="name" class="form-input w-full" type="text" name="name" value="{{ $role->name }}" required/>
                        </div>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
                                @foreach($permissions as $value)
                                    <label class="inline-flex items-center">
                                        <input type="checkbox" name="permission[]" value="{{ $value->name }}" class="form-checkbox text-indigo-600" {{ in_array($value->name, $rolePermissions) ? 'checked' : '' }}>
