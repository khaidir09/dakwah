<x-app-layout>
    <div class="px-4 sm:px-6 lg:px-8 py-8 w-full">
        ...
        <div class="max-w-5xl mx-auto flex flex-col lg:flex-row lg:space-x-8 xl:space-x-16">
            ...
            <div>
                <div class="mb-6">
                    <a class="btn-sm px-3 bg-white dark:bg-gray-800 border-gray-200 dark:border-gray-700/60 hover:border-gray-300 dark:hover:border-gray-600 text-gray-800 dark:text-gray-300" href="{{ route('meetups') }}">
                ...
                <!-- Image -->
                <figure class="mb-6">
                    <img class="w-full rounded-xs" src="{{ asset('images/meetup-image.jpg') }}" width="640" height="360" alt="Meetup" />
                </figure>
                ...
                <div>
                    ...
                    <div class="grid grid-cols-3 gap-4 my-6">
                        <a class="block" href="#0">
                            <img class="w-full rounded-xs" src="{{ asset('images/meetup-photo-01.jpg') }}" width="203" height="152" alt="Meetup photo 01" />
                        </a>
                        <a class="block" href="#0">
                            <img class="w-full rounded-xs" src="{{ asset('images/meetup-photo-02.jpg') }}" width="203" height="152" alt="Meetup photo 02" />
                        </a>
                        <a class="block" href="#0">
                            <img class="w-full rounded-xs" src="{{ asset('images/meetup-photo-03.jpg') }}" width="203" height="152" alt="Meetup photo 03" />
                        </a>
                    </div>
                </div>
                                ...
                                <div class="flex justify-between items-center mt-3">
                                    ...
                                    <div class="flex items-center space-x-2">
                                        <div class="flex -space-x-3 -ml-0.5">
                                            <img class="rounded-full border-2 border-white dark:border-gray-800 box-content" src="{{ asset('images/avatar-02.jpg') }}" width="28" height="28" alt="User 02" />
                                            <img class="rounded-full border-2 border-white dark:border-gray-800 box-content" src="{{ asset('images/avatar-03.jpg') }}" width="28" height="28" alt="User 03" />
                                            <img class="rounded-full border-2 border-white dark:border-gray-800 box-content" src="{{ asset('images/avatar-04.jpg') }}" width="28" height="28" alt="User 04" />
                                        </div>
