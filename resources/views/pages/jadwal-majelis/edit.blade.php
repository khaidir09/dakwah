                ...
                <div class="bg-white dark:bg-gray-800 p-6 shadow sm:rounded-tl-md sm:rounded-tr-md">
                    <div class="grid md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <select id="access" class="form-select w-full @error('access') is-invalid @enderror" name="access" required>
                                ...
                                <option value="Umum" @if(old('access', $jadwal->access) == 'Umum') selected @endif>Umum</option>
                                <option value="Ikhwan" @if(old('access', $jadwal->access) == 'Ikhwan') selected @endif>Ikhwan</option>
                                <option value="Akhwat" @if(old('access', $jadwal->access) == 'Akhwat') selected @endif>Akhwat</option>
                            </select>
                            @error('access')
                                <div class="text-xs mt-1 text-red-500">{{ $message }}</div>
                            @enderror
                    ...
                    <div class="grid grid-cols-1 mt-6">
                        <div>
                            ...
                            <textarea class="form-textarea w-full @error('deskripsi') is-invalid @enderror" name="deskripsi" id="deskripsi" cols="30" rows="10">{{ old('deskripsi', $jadwal->deskripsi) }}</textarea>
                            @error('deskripsi')
                                <div class="text-xs mt-1 text-red-500">{{ $message }}</div>
                            @enderror
                        </div>
