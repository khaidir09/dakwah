            ...
            <div class="max-w-3xl mx-auto">
                ...
                <div class="-mt-12 mb-2">
                    <div class="inline-flex -ml-1 -mt-1 sm:mb-0">
                        <img class="rounded-full border-4 border-white dark:border-gray-900" src="{{ asset('images/company-icon-01.svg') }}" width="104" height="104" alt="Avatar" />
                    </div>
                </div>
                        ...
                        <div class="bg-white dark:bg-gray-800 shadow-xs rounded-xl px-5 py-4">
                            <div class="md:flex justify-between items-center space-y-4 md:space-y-0 space-x-2">
                                ...
                                <div class="flex items-start space-x-3 md:space-x-4">
                                    ...
                                    <div>
                                        <a class="inline-flex font-semibold text-gray-800 dark:text-gray-100" href="{{ route('job-post') }}">Senior Web App Designer</a>
                                        <div class="text-sm">Full-time / Remote / London, UK</div>
                                    </div>
                                </div>
                                <!-- Right side -->
                                <div class="flex items-center space-x-4 pl-10 md:pl-0">
                                    <div class="text-sm text-gray-500 dark:text-gray-400 italic whitespace-nowrap">Jan 3</div>
                                    <button class="text-gray-300 dark:text-gray-600 hover:text-gray-400 dark:hover:text-gray-500">
                                        <span class="sr-only">Bookmark</span>
                                        <svg class="w-3 h-4 fill-current" width="12" height="16" xmlns="http://www.w3.org/2000/svg">
                                            <path d="M2 0C.9 0 0 .9 0 2v14l6-3 6 3V2c0-1.1-.9-2-2-2H2Z" />
                        ...
                        <div class="bg-white dark:bg-gray-800 shadow-xs rounded-xl px-5 py-4">
                            <div class="md:flex justify-between items-center space-y-4 md:space-y-0 space-x-2">
                                ...
                                <div class="flex items-start space-x-3 md:space-x-4">
                                    ...
                                    <div>
                                        <a class="inline-flex font-semibold text-gray-800 dark:text-gray-100" href="{{ route('job-post') }}">Senior UI/UX Designer</a>
                                        <div class="text-sm">Full-time / Remote / London, UK</div>
                                    </div>
                                </div>
                                <!-- Right side -->
                        ...
                        <div class="bg-white dark:bg-gray-800 shadow-xs rounded-xl px-5 py-4">
                            <div class="md:flex justify-between items-center space-y-4 md:space-y-0 space-x-2">
                                ...
                                <div class="flex items-start space-x-3 md:space-x-4">
                                    ...
                                    <div>
                                        <a class="inline-flex font-semibold text-gray-800 dark:text-gray-100" href="{{ route('job-post') }}">Financial Planning & Analysis Manager</a>
                                        <div class="text-sm">Full-time / Remote / London, UK</div>
                                    </div>
                                </div>
                                <!-- Right side -->
                                <div class="flex items-center space-x-4 pl-10 md:pl-0">
                                    <div class="text-sm text-gray-500 dark:text-gray-400 italic whitespace-nowrap">Jan 2</div>
                                    <button class="text-gray-300 dark:text-gray-600 hover:text-gray-400 dark:hover:text-gray-500">
                                        <span class="sr-only">Bookmark</span>
                                        <svg class="w-3 h-4 fill-current" width="12" height="16" xmlns="http://www.w3.org/2000/svg">
                                            <path d="M2 0C.9 0 0 .9 0 2v14l6-3 6 3V2c0-1.1-.9-2-2-2H2Z" />
                        ...
                        <div class="bg-white dark:bg-gray-800 shadow-xs rounded-xl px-5 py-4">
                            <div class="md:flex justify-between items-center space-y-4 md:space-y-0 space-x-2">
                                ...
                                <div class="flex items-start space-x-3 md:space-x-4">
                                    ...
                                    <div>
                                        <a class="inline-flex font-semibold text-gray-800 dark:text-gray-100" href="{{ route('job-post') }}">Senior Consultant Growth Strategy</a>
                                        <div class="text-sm">Full-time / Remote / London, UK</div>
                                    </div>
                                </div>
                                <!-- Right side -->
