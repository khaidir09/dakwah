    ...
    <div class="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-[96rem] mx-auto">
        ...
        <div class="sm:flex sm:justify-between sm:items-center mb-8">
            <div class="mb-4 sm:mb-0">
                <h1 class="text-2xl md:text-3xl text-gray-800 dark:text-gray-100 font-bold">Tambah Majelis Baru</h1>
            </div>
        ...
        <div>
            <form action="{{ route('majelis-ku.store') }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="bg-white dark:bg-gray-800 p-6 shadow sm:rounded-tl-md sm:rounded-tr-md">
                        ...
                        <div>
                            ...
                            <select id="teacher_id" class="form-select w-full @error('teacher_id') is-invalid @enderror" name="teacher_id" required>
                                ...
                                @foreach($teachers as $item)
                                    <option value="{{ $item->id }}" @if(old('teacher_id') == $item->id) selected @endif>{{ $item->name }}</option>
                                @endforeach
                            </select>
                            @error('teacher_id')
                                <div class="text-xs mt-1 text-red-500">{{ $message }}</div>
                    ...
                    <div class="grid grid-cols-4 gap-4">
                        ...
                        <div>
                            ...
                            <select id="province" class="form-select w-full @error('province') is-invalid @enderror" name="province" required>
                                ...
                                @foreach($provinces as $code => $name)
                                    <option value="{{ $code }}" {{ old('province') == $code ? 'selected' : '' }}>
                                        {{ $name }}
                                    </option>
                                @endforeach
                            </select>
                        ...
                        <div>
                            ...
                            <select id="city" class="form-select w-full @error('city') is-invalid @enderror" name="city" required data-selected="{{ old('city') }}">
                                <option value="">==Pilih Salah Satu==</option>
                            </select>
                            @error('city')
                                <div class="text-xs mt-1 text-red-500">{{ $message }}</div>
                        ...
                        <div>
                            ...
                            <select id="district" class="form-select w-full" name="district" data-selected="{{ old('district') }}">
                                <option value="">==Pilih Salah Satu==</option>
                            </select>
                        </div>
                        ...
                        <div>
                            ...
                            <select id="village" class="form-select w-full" name="village" data-selected="{{ old('village') }}">
                                <option value="">==Pilih Salah Satu==</option>
                            </select>
                        </div>
                    </div>
