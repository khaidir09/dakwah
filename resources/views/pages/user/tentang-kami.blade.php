            ...
            <section class="bg-white dark:bg-gray-800 rounded-2xl shadow-sm p-8 md:p-12">
                <div class="md:flex md:items-center md:gap-12">
                    ...
                    <div class="md:w-1/2">
                        ...
                        <p class="text-gray-600 dark:text-gray-300 mb-4 leading-relaxed text-justify">
            ...
            <section>
                ...
                <div class="grid md:grid-cols-3 gap-8">
                    ...
                    <div class="bg-white dark:bg-gray-800 p-8 rounded-xl shadow-sm hover:shadow-md transition-shadow border-t-4 border-emerald-500">
                        ...
                        <h3 class="text-xl font-bold text-gray-900 dark:text-white mb-3">Khidmah (Pelayanan)</h3>
                        <p class="text-gray-600 dark:text-gray-400 text-sm text-justify">
            ...
            <section class="max-w-7xl mx-auto" x-data="advisorCarousel">
                <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-sm overflow-hidden border border-gray-100 dark:border-gray-700">
                    <div class="grid md:grid-cols-2">
                        <!-- Carousel Column -->
                        <div class="relative h-96 md:h-auto bg-gray-200 dark:bg-gray-700">
                            <!-- Slides -->
                            <template x-for="(slide, index) in slides" :key="index">
                                <div x-show="activeSlide === index"
                                    ...
                                    <img :src="slide" class="w-full h-full object-cover" alt="Foto Penasihat">
                                </div>
                            </template>
            
                            <!-- Navigation Arrows -->
                            <div class="absolute inset-x-0 bottom-4 flex justify-center gap-2">
                                <button @click="prev" class="bg-black/30 hover:bg-black/50 text-white p-2 rounded-full backdrop-blur-sm transition-colors focus:outline-none">
                                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 19l-7-7 7-7"></path></svg>
                                </button>
                                <button @click="next" class="bg-black/30 hover:bg-black/50 text-white p-2 rounded-full backdrop-blur-sm transition-colors focus:outline-none">
                            ...
                            <div class="absolute top-4 right-4 flex gap-1">
                                <template x-for="(slide, index) in slides" :key="index">
                                    <div class="w-2 h-2 rounded-full transition-colors" 
                                         :class="activeSlide === index ? 'bg-white' : 'bg-white/50'"></div>
                                </template>
                            </div>
                        </div>
                        ...
                        <div class="p-8 md:p-12 flex flex-col justify-center">
                            <span class="text-emerald-600 font-semibold tracking-wider uppercase text-sm mb-2">Penasihat Kami</span>
                            <h2 class="text-3xl font-bold text-gray-900 dark:text-white mb-6 font-serif">Mu'allim H. Ahmad Humaidi, Lc, M.Pd.I</h2>
                            <div class="prose prose-emerald text-gray-600 dark:text-gray-300">
                                <p class="text-justify">
                                    Alhamdulillah, setiap langkah pengembangan Syaikhuna tidak lepas dari doa dan arahan Tuan Guru. Beliau memandu kami, para anak muda di balik layar, agar aplikasi ini tidak sekadar canggih teknologinya, tapi juga membawa keberkahan bagi siapa saja yang menggunakannya. Beliau memastikan bahwa sanad keilmuan yang kami tampilkan bersambung dan valid.
                                </p>
                                {{-- Qoutes --}}
