                    ...
                    <div class="md:py-8">
                        ...
                        <div class="space-y-4">
                            ...
                            <div class="flex justify-between items-center mb-6">
                                ...
                                <div>
                                    <a class="text-sm font-medium text-violet-500 hover:text-violet-600 dark:hover:text-violet-400" href="{{ route('guru-list') }}">&lt;- Kembali</a>
                                </div>
                            </div>
                                ...
                                <div class="relative pb-8 mt-6">
                                    ...
                                    <header class="text-center sm:text-left mb-6">
                                        ...
                                        <div class="flex flex-wrap justify-center sm:justify-start space-x-4">
                                            <div class="flex items-center">
                                                ...
                                                <span class="text-sm font-medium whitespace-nowrap text-gray-500 dark:text-gray-400 ml-2">{{ $teacher->village->name }}, {{ $teacher->district->name }}, {{ $teacher->province->name }}</span>
                                            </div>
                                        </div>
                                    </header>
                                    ...
                                    <div class="flex flex-col xl:flex-row xl:space-x-16">
                                        ...
                                        {{-- <aside class="xl:min-w-56 xl:w-56 space-y-3">
                                            <div class="text-sm">
                                                <h3 class="font-medium text-gray-800 dark:text-gray-100">Tahun Lahir</h3>
                                                <div>{{ $teacher->tahun_lahir }}</div>
                                            </div>
                                        </aside> --}}
