                    ...
                    <div class="md:py-8">
                        ...
                        <div class="space-y-4">
                            ...
                            <div class="flex justify-between items-center mb-6">
                                ...
                                <div>
                                    <a class="text-sm font-medium text-emerald-500 hover:text-emerald-600 dark:hover:text-emerald-400" href="{{ route('guru-list') }}">&lt;- Kembali</a>
                                </div>
                            </div>
                                                ...
                                                <div class="space-y-4">
                                                    ...
                                                    @foreach ($schedules as $item)
                                                        <div class="bg-white dark:bg-gray-900 p-4 border border-gray-200 dark:border-gray-700/60 rounded-lg shadow-xs">
                                                            ...
                                                            <!-- Card content -->
                                                            <div class="text-sm mb-3">{!! nl2br(e($item->deskripsi)) !!}</div>
                                                            <!-- Card footer -->
