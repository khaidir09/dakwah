                        ...
                        <article class="bg-white dark:bg-gray-800 shadow-sm rounded-xl p-6 md:p-8">
                            ...
                            @if ($post->attachment_path)
                                <div class="mt-8 pt-6 border-t border-gray-100 dark:border-gray-700">
                                    <h3 class="text-lg font-semibold text-gray-800 dark:text-gray-100 mb-2">Dokumen Terkait</h3>
                                    <p class="text-sm text-gray-500 dark:text-gray-400 mb-3">{{ $post->attachment_label ?: $post->attachment_filename }}</p>
                                    @auth
                                        <a href="{{ route('tulisan.download', $post->slug) }}" class="inline-flex items-center px-4 py-2 bg-blue-600 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-blue-700 active:bg-blue-900 focus:outline-none focus:border-blue-900 focus:ring ring-blue-300 disabled:opacity-25 transition ease-in-out duration-150">
                                    ...
                                    @else
                                        ...
                                        <p class="text-xs text-gray-400 dark:text-gray-500 mt-2">Anda harus login terlebih dahulu untuk mengunduh dokumen ini.</p>
                                    @endauth
                                </div>
                            @endif
                        </article>
