                        ...
                        <div class="space-y-4">
                            ...
                            >
                                ...
                                <div class="relative pb-8 mt-6">
                                    ...
                                    <div class="flex flex-col items-center sm:flex-row sm:justify-between sm:items-start mb-6">
                                        <!-- Header -->
                                        <header class="text-center sm:text-left ">
                                            ...
                                            <div class="flex flex-wrap justify-center sm:justify-start space-x-4">
                                                <div class="flex items-center">
                                                    ...
                                                    <span class="text-sm font-medium whitespace-nowrap text-gray-500 dark:text-gray-400 ml-2">{{ $assembly->alamat }}</span>
                                                </div>
                                            </div>
                                        </header>
                                        <!-- Actions -->
