                    ...
                    <div class="md:py-8">
                        ...
                        <div class="space-y-4">
                            ...
                            <div class="bg-white dark:bg-gray-800 shadow-sm rounded-xl p-5">
                                ...
                                <!-- Form Pencarian Catatan -->
                                <form action="{{ route('jadwal-majelis-detail', $schedule->id) }}" method="GET" class="mb-6 relative w-full">
                                    <div class="relative">
                                        ...
                                        <input type="text" name="search" id="search" value="{{ request('search') }}" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-emerald-500 focus:border-emerald-500 block w-full pl-10 p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-emerald-500 dark:focus:border-emerald-500" placeholder="Cari kata kunci catatan...">
                                    </div>
                                    @if(request('search'))
                                    <div class="mt-2 text-sm text-gray-500">
                                        Menampilkan hasil pencarian untuk: <strong>{{ request('search') }}</strong>. <a href="{{ route('jadwal-majelis-detail', $schedule->id) }}" class="text-emerald-500 hover:underline">Reset</a>
                                    </div>
                                    @endif
                                </form>
