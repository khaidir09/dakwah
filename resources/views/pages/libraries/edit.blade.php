                ...
                <div class="bg-white dark:bg-gray-800 p-6 shadow sm:rounded-tl-md sm:rounded-tr-md">
                    <div class="grid md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <input id="notebook_id" class="form-input w-full @error('notebook_id') is-invalid @enderror" type="text" name="notebook_id" value="{{ old('notebook_id', $library->notebook_id) }}" />
